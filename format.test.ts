...
Deno.test('format yy', () => {
  let date = new Date(2023, 2, 5, 3, 43, 56, 678)
  let dateText = format(date, 'yy')
  assertEquals(dateText, '23')
})

Deno.test('format yyyy', () => {
  let date = new Date(923, 2, 5, 3, 43, 56, 678)
...
Deno.test('format h', () => {
  let date = new Date(2023, 2, 5, 13, 43, 56, 678)
  let dateText = format(date, 'h')
...
Deno.test('format m', () => {
  let date = new Date(2023, 2, 5, 13, 4, 56, 678)
  let dateText = format(date, 'm')
