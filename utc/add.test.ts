...
Deno.test('add integer(unit: months)', () => {
  ...
  assertEquals(newDate.getTime(), new Date(2033, 11).getTime())
})
...
Deno.test('add integer(unit: days)', () => {
  ...
  assertEquals(newDate.getTime(), new Date(2033, 11, 30).getTime())
})
...
Deno.test('add integer(unit: hours)', () => {
  ...
  assertEquals(newDate.getTime(), new Date(2033, 11, 30, 23).getTime())
})
...
Deno.test('add integer(unit: minutes)', () => {
  ...
  assertEquals(newDate.getTime(), new Date(2033, 11, 30, 23, 59).getTime())
})
...
Deno.test('add integer(unit: seconds)', () => {
  ...
  assertEquals(newDate.getTime(), new Date(2033, 11, 30, 23, 59, 59).getTime())
})