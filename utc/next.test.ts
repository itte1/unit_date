...
Deno.test('next minutes', () => {
  ...
  assertEquals(newDate.getTime(), new Date(2023, 2, 18, 3, 44, 4).getTime())
})
...
Deno.test('next minutes carry up', () => {
  let date = new Date(2023, 2, 18, 3, 59, 56, 678)
  let newDate = next(date, { seconds: 4 })
  assertEquals(newDate.getTime(), new Date(2023, 2, 18, 4, 0, 4).getTime())
})

Deno.test('next minutes same minutes', () => {
  let date = new Date(2023, 2, 18, 3, 43, 56, 678)
  let newDate = next(date, { seconds: 59 })
  assertEquals(newDate.getTime(), new Date(2023, 2, 18, 3, 43, 59).getTime())
})

Deno.test('next minutes same minutes(unit: minutes)', () => {
  let date = new Date(2023, 2, 18, 3, 43, 56, 678)
  let newDate = next(date, { seconds: 59 }, 'minutes')
  assertEquals(newDate.getTime(), new Date(2023, 2, 18, 3, 44, 59).getTime())
})

Deno.test('next hours', () => {
  let date = new Date(2023, 2, 18, 3, 43, 56, 678)
  let newDate = next(date, { minutes: 15, seconds: 4 })
  assertEquals(newDate.getTime(), new Date(2023, 2, 18, 4, 15, 4).getTime())
})

Deno.test('next hours carry up', () => {
  let date = new Date(2023, 2, 18, 23, 43, 56, 678)
  let newDate = next(date, { minutes: 15, seconds: 4 })
  assertEquals(newDate.getTime(), new Date(2023, 2, 19, 0, 15, 4).getTime())
})

Deno.test('next hours same hours', () => {
  let date = new Date(2023, 2, 18, 3, 43, 56, 678)
  let newDate = next(date, { minutes: 59, seconds: 4 })
  assertEquals(newDate.getTime(), new Date(2023, 2, 18, 3, 59, 4).getTime())
})

Deno.test('next hours same hours(unit: hours)', () => {
  let date = new Date(2023, 2, 18, 3, 43, 56, 678)
  let newDate = next(date, { minutes: 59, seconds: 4 }, 'hours')
  assertEquals(newDate.getTime(), new Date(2023, 2, 18, 4, 59, 4).getTime())
})
