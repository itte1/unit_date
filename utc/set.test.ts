...
Deno.test('set days(unit: none)', () => {
  let date = new Date(Date.UTC(2023, 1, 18, 3, 43, 56, 678))
...
Deno.test('set integer(unit: months)', () => {
  ...
  assertEquals(newDate.getTime(), new Date(Date.UTC(2033, 3)).getTime())
})
...
Deno.test('set integer(unit: days)', () => {
  ...
  assertEquals(newDate.getTime(), new Date(Date.UTC(2033, 3, 16)).getTime())
})
...
Deno.test('set integer(unit: hours)', () => {
  ...
  assertEquals(newDate.getTime(), new Date(Date.UTC(2033, 3, 16, 13)).getTime())
})
...
Deno.test('set integer(unit: minutes)', () => {
  ...
  assertEquals(newDate.getTime(), new Date(Date.UTC(2033, 3, 16, 13, 16)).getTime())
})
...
Deno.test('set integer(unit: seconds)', () => {
  ...
  assertEquals(newDate.getTime(), new Date(Date.UTC(2033, 3, 16, 13, 16, 12)).getTime())
})